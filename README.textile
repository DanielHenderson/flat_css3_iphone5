h1. CSS3 Flat iPhone5 + Auto Scroll

An flat iPhone5 element made with CSS3 that holds a scrollable image.
Used to display or present content of mobile pages.
